...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2026 at 05:15 AM
...
INSERT INTO `diagnostic_reports` (`id`, `issued_to`, `issue_date`, `date_of_purchase`, `supplier`, `item_description`, `serial_number`, `problem`, `recommendation`, `recommended_by`, `noted_by`, `approved_by`, `created_at`) VALUES
(1, 'test', '2026-04-04', '2026-04-03', 'test', 'TEST', 'TEST', 'TEST', 'TEST', 'TEST', 'TEST', 'TEST', '2026-04-04 07:22:03'),
(2, 'test', '2026-04-04', '2026-03-31', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', '2026-04-04 07:52:39');
...
(106, 'Andrei', 'andrei', '2026-04-07', '2026-04-07 02:59:00', NULL, 'TOTCI', 'juan', 'juan', 'juan', 'juan'),
(107, 'Andrei', 'Arvie', '2026-04-13', '2026-04-13 07:54:41', NULL, 'itd', 'Andrei', 'Anjo S. Fuentes', 'Arvie', 'Andrei'),
(108, 'Andrei', 'Arvie', '2026-04-13', '2026-04-13 07:56:01', NULL, 'itd', 'Andrei', 'Anjo S. Fuentes', 'Arvie', 'Andrei'),
(109, 'Andrei', 'Arvie', '2026-04-13', '2026-04-13 07:56:56', NULL, 'itd', 'Andrei', 'Anjo S. Fuentes', 'Arvie', 'Andrei'),
(110, 'Andrei', 'Arvie', '2026-04-13', '2026-04-13 07:57:49', NULL, 'itd', 'Andrei', 'Anjo S. Fuentes', 'Arvie', 'Andrei'),
(111, 'Andrei', 'IT DEPARTMENT', '2026-04-13', '2026-04-13 08:09:05', NULL, 'itd', 'Andrei', 'Andrei', 'Andrei', 'Andrei'),
(112, 'Andrei', 'IT DEPARTMENT', '2026-04-13', '2026-04-13 08:11:00', NULL, 'itd', 'Andrei', 'Andrei', 'Andrei', 'Andrei'),
(113, 'Andrei', 'IT DEPARTMENT', '2026-04-13', '2026-04-13 08:11:08', NULL, 'itd', 'Andrei', 'Andrei', 'Andrei', 'Andrei'),
(114, 'Andrei', 'IT DEPARTMENT', '2026-04-13', '2026-04-13 08:11:55', NULL, 'itd', 'Andrei', 'Andrei', 'Andrei', 'Andrei'),
(115, 'Andrei', 'IT DEPARTMENT', '2026-04-13', '2026-04-13 08:12:56', NULL, 'itd', 'Andrei', 'Andrei', 'Andrei', 'Andrei'),
(116, 'Andrei', 'IT DEPARTMENT', '2026-04-13', '2026-04-13 08:15:25', NULL, 'itd', 'Andrei', 'Andrei', 'Andrei', 'Andrei'),
(117, '1', '1', '2026-04-13', '2026-04-13 08:31:57', NULL, 'itd', '', '', '', ''),
(118, '1', '1', '2026-04-13', '2026-04-13 08:37:40', NULL, 'itd', '', '', '', ''),
(119, 'Andrei', 'example', '2026-04-13', '2026-04-13 09:09:51', NULL, 'itd', 'example', 'example', 'example', 'example'),
(120, 'andrei', 'arvie', '2026-04-14', '2026-04-14 01:32:40', NULL, 'itd', 'andrei', 'andrei', 'andrei', 'andrei');
...
(116, 106, 1, 'l', '2026-04-07 02:59:00'),
(117, 107, 1, 'Laptop', '2026-04-13 07:54:41'),
(118, 107, 2, 'mouse', '2026-04-13 07:54:41'),
(119, 108, 1, 'Laptop', '2026-04-13 07:56:01'),
(120, 108, 2, 'mouse', '2026-04-13 07:56:01'),
(121, 109, 1, 'Laptop', '2026-04-13 07:56:56'),
(122, 109, 2, 'mouse', '2026-04-13 07:56:56'),
(123, 110, 1, 'Laptop', '2026-04-13 07:57:49'),
(124, 110, 2, 'mouse', '2026-04-13 07:57:49'),
(125, 111, 1, '1', '2026-04-13 08:09:05'),
(126, 112, 1, '1', '2026-04-13 08:11:00'),
(127, 113, 1, '1', '2026-04-13 08:11:08'),
(128, 114, 1, '1', '2026-04-13 08:11:55'),
(129, 115, 1, '1', '2026-04-13 08:12:56'),
(130, 116, 1, '1', '2026-04-13 08:15:25'),
(131, 117, 1, '1', '2026-04-13 08:31:57'),
(132, 118, 1, '1', '2026-04-13 08:37:40'),
(133, 119, 1, 'example', '2026-04-13 09:09:51'),
(134, 120, 1, 'laptop', '2026-04-14 01:32:40'),
(135, 120, 2, 'mouse', '2026-04-14 01:32:40');
...
(15, 'manzanes.a.bsinfotech@gmail.com', 'andrei', 'TOPLIS Solutions', 'ITD-EXAMPLE', 'borrow', 'Laptop, Mouse, Keyboard, Charger, Headset, Others', '2026-04-13', '2026-04-30', '2026-04-13 09:13:17');
...
(1, '', '$2y$10$8aPjX9Jw5WZLCF5ssJF8FuIhHSYU99yKV7ts5WITUQXbq8xVhwaYW', 'LG28911', 'admin'),
(2, NULL, '$2y$10$GpgTiw1THcPO8dgaEmTat.lj72wFJnww1HbFuk.RxvDwDW6zNfczm', 'testuser01', 'admin'),
(3, NULL, '$2y$10$A6uBlJ0PR2bu6zTZvUi/KOs6681zkOz0PUfpIV2jrqBLPSn0fin82', 'TSI21056', 'admin'),
(4, NULL, '$2y$10$X6.A6KSWcKWikD3QG01zGOUZD465kRUBrl9UqVf4XYq2emhF1E7Ta', 'test002', 'user'),
(5, NULL, '$2y$10$AGN70FKTg3jQEe/17iSw7.NckveGWZ65Y.7QlycchohBLYNtSVsHa', 'ojt606', 'user'),
(6, NULL, '$2y$10$B3kaD1yclJNknH8458sGtuFblY9ZOO/je8wp9dTO2yBjds0i5tiYu', 'OJT111', 'user'),
(7, NULL, '$2y$10$YzdnyLVxpJF0YTSLLunrPeuHIwYiWCQwJjbRO.M5ML1HPA18Z4zy.', 'OJT 100', 'user');
...
INSERT INTO `videos` (`id`, `title`, `description`, `video_file`, `created_at`) VALUES
(2, 'test', 'test to other folder', 'C:\\ITD Inhouse folders\\videos\\Transaction_-_Previous_and_Next_Buttons_1775277024.mp4', '2026-04-04 04:30:24'),
(5, 'test', 'test uli', 'C:\\ITD Inhouse folders\\videos\\Minimizing_Browser_to_Search_Region_in_Shipper_1775281247.mp4', '2026-04-04 05:40:47');
